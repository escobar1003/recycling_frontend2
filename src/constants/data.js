...
export const GL = "#dcfce7";
export const GS = "#15803d";
export const Y  = "#facc15";
export const YD = "#ca8a04";

// ── Configuración de materiales ───────────────────────────────────────────────
export const MAT_CFG = {
  "Plástico (PET)": { pts: 30, icon: "bi-bag"              },
  "Cartón":         { pts: 20, icon: "bi-box-seam"          },
  "Vidrio":         { pts: 25, icon: "bi-cup-straw"         },
  "Aluminio":       { pts: 40, icon: "bi-cup"               },
  "Papel":          { pts: 15, icon: "bi-file-earmark"      },
  "Tetrapack":      { pts: 18, icon: "bi-box2"              },
  "Electrónicos":   { pts: 60, icon: "bi-phone"             },
  "Metal":          { pts: 35, icon: "bi-gear"              },
  "Orgánico":       { pts: 10, icon: "bi-tree"              },
  "Tela":           { pts: 22, icon: "bi-scissors"          },
  "Mixto":          { pts: 12, icon: "bi-recycle"           },
};
...
export const ZONAS = [
  ...
  "Zona Occidente", "Zona Chapinero", "Zona Suba", "Zona Kennedy",
];
...
export const REWARDS = [
  { id: 1, titulo: "Café gratis",        empresa: "Juan Valdez",        pts: 500,  icon: "bi-cup-hot-fill",      color: "#854d0e" },
  { id: 2, titulo: "10% descuento",      empresa: "Éxito Supermercado", pts: 1000, icon: "bi-cart-fill",         color: "#16a34a" },
  { id: 3, titulo: "Entrada cine",       empresa: "Cinépolis",          pts: 2000, icon: "bi-camera-reels-fill", color: "#7c3aed" },
  { id: 4, titulo: "Transporte gratis",  empresa: "TransMilenio",       pts: 800,  icon: "bi-bus-front-fill",    color: "#0f766e" },
  { id: 5, titulo: "Descuento farmacia", empresa: "Farmatodo",          pts: 1200, icon: "bi-capsule",           color: "#1e40af" },
  { id: 6, titulo: "Bono restaurante",   empresa: "Crepes & Waffles",   pts: 1500, icon: "bi-egg-fried",         color: "#c2410c" },
];
